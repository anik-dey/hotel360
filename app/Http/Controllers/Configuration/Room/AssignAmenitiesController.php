...
class AssignAmenitiesController extends Controller
{
    /**
    ...
    public function index()
    {
        try{
            ...
            $data['amenities'] = Amenity::whereIn('property_id',$mapping)->get();
            return view('modules.configuration.room_setting.assignAmenities',$data);
        } catch(\Exception$e){
