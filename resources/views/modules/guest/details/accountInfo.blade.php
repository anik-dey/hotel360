    ...
    <form class="validate-form" novalidate="novalidate">
        <div class="row">
            <div class="col-md-4">
                ...
                <div class="accImage">
                    <img src="{{ asset('guest_picture/'.$guest->image) }}">
                </div>
            </div>
            <div class="col-md-4">
                <label>Passport Attachment</label>
                <div class="accImage">
                    <img src="{{ asset('guest_picture/'.$guest->passport_attach) }}">
                </div>
            </div>
            <div class="col-md-4">
                <label>Visa Attachment</label>
                <div class="accImage">
                    <img src="{{ asset('guest_picture/'.$guest->visa_attach) }}">
                </div>
            </div>
        </div>
        <hr>
        <div class="row">
            ...
            <div class="col-xl-4 col-md-6 col-sm-12 mb-2">
                ...
                <div class="input-group input-group-merge">
                    <input type="text" class="form-control phone-number-mask" name="phone" value="{{ $guest->phone }}"
                        id="phone-number" readonly>
                </div>
            </div>
            <div class="col-xl-4 col-md-6 col-sm-12 mb-2">
                <label for="date">Email</label>
                <input type="email" class="form-control date-mask" value="{{ $guest->email }}" name="email" readonly>
            </div>
            <input type="hidden" name="is_email_verify" value="1">
            <div class="col-xl-4 col-md-6 col-sm-12 mb-2">
                <label for="time">Date Of Birth</label>
                <input type="text" class="form-control time-mask" id="time" name="dob" value="{{ $guest->dob }}"
                    readonly>
            </div>
            <div class="col-xl-4 col-md-6 col-sm-12 mb-2">
            ...
            <div class="col-xl-4 col-md-6 col-sm-12 mb-2">
                ...
                <input type="text" class="form-control block-mask" name="nid" value="{{ $guest->nid }}" id="blocks"
                    readonly>
            </div>
            ...
            <div id="div1" class="col-xl-4 col-md-6 col-sm-12 mb-2" @if($guest->
                is_native==0) style="display:none" @endif>
            ...
            <div id="div2" class="col-xl-4 col-md-6 col-sm-12 mb-2" @if($guest->
                is_native==0) style="display:none" @endif>
            ...
            <div id="div3" class="col-xl-4 col-md-6 col-sm-12 mb-2" @if($guest->
                is_native==0) style="display:none" @endif>
                <label for="prefix">Visa/Reg. No</label>
                <input type="text" class="form-control prefix-mask" name="visa_no" value="{{ $guest->visa_no }}" id=""
                    readonly>
            </div>
            <div class="form-group col-xl-4 col-md-6 col-sm-12 mb-2">
                <label>Country</label>
                <input type="text" class="form-control delimiter-mask" value="{{ $guest->country->name }}" id=""
                    readonly>
            </div>
            @if($state != '')
                <div class="form-group col-xl-4 col-md-6 col-sm-12 mb-2">
                    <label>State</label>
                    <input type="text" class="form-control delimiter-mask" value="{{ $state->name }}" id="" readonly>
                </div>
            @else
                <div class="form-group col-xl-4 col-md-6 col-sm-12 mb-2">
                    <label>State</label>
            ...
            <div class="form-group col-xl-4 col-md-6 col-sm-12 mb-2">
                <label>City</label>
                @if($city != '')
                    <input type="text" class="form-control delimiter-mask" value="{{ $city->name }}" id="" readonly>
                @else
                    <input type="text" class="form-control delimiter-mask" value="" id="" readonly>
                @endif
            </div>
            <div class="form-group col-xl-4 col-md-6 col-sm-12 mb-2">
                <label>Thana</label>
                @if($thana != '')
                    <input type="text" class="form-control delimiter-mask" value="{{ $thana->name }}" id="" readonly>
                @else
                    <input type="text" class="form-control delimiter-mask" value="" id="" readonly>
                @endif
            </div>
            <div class="form-group col-xl-4 col-md-6 col-sm-12 mb-2">
                ...
                <input type="text" name="landmark" id="landmark" class="form-control" value="{{ $guest->landmark }}"
                    readonly />
            </div>
        </div>
    </form>
