...
<form action="" method="" enctype="multipart/form-data" style="display: none;" id="div1">
    <div class="row">
        <div class="form-group position-relative col-md-4">
            ...
            <select class="form-control select2" id="" name="">
                ...
                <option value="Australia">Other Profit</option>
                <option value="Canada">Admision Fee</option>
                <option value="Russia">Form Fee</option>
                <option value="Saudi Arabia">Bank Profit</option>
    ...
    <div class="row">
        ...
        <div class="form-group position-relative col-md-4">
            <label for="customer-country" class="form-label">Income Amount</label>
            <input type="number" class="form-control date-mask" placeholder="Amount" id="date">
        </div>
        <div class="form-group position-relative col-md-4">
            <label for="customer-country" class="form-label">Income By</label>
            <input type="text" class="form-control date-mask" placeholder="Income By" id="date">
        </div>
    </div>
    <div class="row">
        <div class="form-group position-relative col-md-4">
        ...
        <div class="form-group position-relative col-md-4">
            <label for="customer-country" class="form-label">Credit From Account</label>
            <select class="form-control select2" id="" name="">
                <option>Select</option>
        ...
        <div class="form-group position-relative col-md-4">
            <label for="customer-country" class="form-label">Income Details</label>
        ...
        <div class="card">
            <div class="card-header d-flex flex-row justify-content-end">
                <div class="col-lg-4 col-sm-12 mt-1">
                    <h4 class="card-title">Credit Vouchers</h4>
                </div>
