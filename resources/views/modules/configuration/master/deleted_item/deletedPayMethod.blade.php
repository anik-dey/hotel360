    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <label>
                    <h4 class="card-title">Deleted Payment Mathod List</h4>
                </label>
                <label>
                ...
                <label><a href="{{ route('pay-method.index') }}"><button
                            ...
                            type="button"><span><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                ...
                                </svg>Pay Method List</span></button></a>
                </label>
            </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex justify-content-center">
                                        <a href="{{ route('pay-method-restore',$item->id) }}"
                                        ...
                                        <form id="delete-form-{{ $item->id }}"
                                            action="{{ route('pay-method-force-delete',$item->id) }}"
