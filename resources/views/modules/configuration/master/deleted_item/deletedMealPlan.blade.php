    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <label>
                    <h4 class="card-title">Deleted Meal Plan List</h4>
                </label>
                <label>
                ...
                <label>
                    <a href="{{ route('meal-plan.index') }}"><button
                            ...
                            type="button"><span><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                ...
                                </svg>Meal Plan List</span></button></a>
                </label>
            </div>
            <!-- <div class="card-body">
                <p class="card-text">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex justify-content-center">
                                        <a href="{{ route('meal-plan-restore',$item->id) }}"
                                        ...
                                        <form id="delete-form-{{ $item->id }}"
                                            action="{{ route('meal-plan-force-delete',$item->id) }}"
