    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <label>
                    <h4 class="card-title">Identity Type</h4>
                </label>
                <label>
                                    ...
                                    <div class="d-flex justify-content-center">
                                        <div style="margin-left: 7px">
                                            <button type="button" class="btn btn-primary btn-sm" data-toggle="modal"
                                                data-target="#modals-edit-identity{{ $item->id }}">
                                        ...
                                        <div>
                                            <div style="margin-left: 7px">
                                                ...
                                                <form style="display: none" id="delete-form-{{ $item->id }}"
                                                    action="{{ route('identity-type.destroy',$item->id) }}"
                                                    method="POST">
                                                    @method('delete')
                                                    @csrf
                                                </form>
...
{!! $identity->links() !!}
{{-- Identity Type Add Modal Start --}}
<div class="modal modal-slide-in fade" id="modals-add-identity">
    <div class="modal-dialog sidebar-sm">
        <form class="add-new-record modal-content pt-0" action="{{ route('identity-type.store') }}"
            method="POST">
            @csrf
            @method('POST')
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">×</button>
            <div class="modal-header mb-1">
                <h5 class="modal-title" id="exampleModalLabel">Add New Identity</h5>
            </div>
            <div class="modal-body flex-grow-1">
                <div class="form-group">
                    <label for="">Identity Name</label>
                    <input class="form-control" type="text" name="name" placeholder="Identity Name Here"
