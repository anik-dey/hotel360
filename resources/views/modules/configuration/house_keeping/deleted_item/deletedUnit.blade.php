    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <label>
                    <h4 class="card-title">Deleted Units List</h4>
                </label>
                <label>
                ...
                <label><a href="{{ route('unit.index') }}"><button
            ...
            <div class="table-responsive">
                <table class="table table-bordered">
                    ...
                    <tbody id="myTable">
                        ...
                        @empty
                            <tr>
                                <td class="text-danger" align="center" colspan="7">No Data Founds</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
