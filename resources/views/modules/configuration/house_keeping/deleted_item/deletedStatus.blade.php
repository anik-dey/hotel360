    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <label>
                    <h4 class="card-title">Deleted Status List</h4>
                </label>
                <label>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex justify-content-center">
                                        <a href="{{ route('status-restore',$item->id) }}"
                                        ...
                                        <form id="delete-form-{{ $item->id }}"
                                            action="{{ route('status-force-delete',$item->id) }}"
