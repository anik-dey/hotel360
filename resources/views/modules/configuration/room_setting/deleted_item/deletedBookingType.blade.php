    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <label>
                    <h4 class="card-title">Deleted Booking Type List</h4>
                </label>
                <label>
                ...
                <label><a href="{{ route('booking-type-list.index') }}"><button
                            ...
                            type="button"><span><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                ...
                                </svg>Booking Type List</span></button></a>
                </label>
            </div>
            <div class="table-responsive">
                <table class="table table-bordered">
                    ...
                    <tbody id="myTable" align="center">
                        @forelse($booking_type as $key => $item)
                            <tr>
                                <td>
                                ...
                                <td>
                                    <div class="d-flex justify-content-center">
                                        <a href="{{ route('booking-type-restore',$item->id) }}"
                                        ...
                                        <form id="delete-form-{{ $item->id }}"
                                            action="{{ route('booking-type-force-delete',$item->id) }}"
