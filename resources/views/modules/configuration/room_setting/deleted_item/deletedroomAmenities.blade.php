    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <label>
                    <h4 class="card-title">Deleted Amenities List</h4>
                </label>
                <label>
                ...
                <label><a href="{{ route('room-amenities.index') }}"><button
                            ...
                            type="button"><span><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                ...
                                </svg>Amenities List</span></button></a>
                </label>
            </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex justify-content-center">
                                        <a href="{{ route('amenities-restore',$item->id) }}"
                                        ...
                                        <form id="delete-form-{{ $item->id }}"
                                            action="{{ route('amenities-force-delete',$item->id) }}"
