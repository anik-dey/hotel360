...
<div class="content-body">
    <section id="faq-search-filter">
        <div class="card faq-search card-body text-center pt-5"
            style="height: 300px ;background-image: url('{{ asset('backend/app-assets/images/banner/banner.png') }}">
            ...
            <div class="col-lg-3 col-md-4 col-sm-12">
                <div class="faq-navigation d-flex justify-content-between flex-column mb-2 mb-md-0">
                    <ul class="nav nav-pills nav-left flex-column" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="payment" data-toggle="pill" href="#faq-payment"
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="delivery" data-toggle="pill" href="#faq-delivery"
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="cancellation-return" data-toggle="pill"
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="my-order" data-toggle="pill" href="#faq-my-order"
                                aria-expanded="false" role="tab">
                        ...
                        <div class="collapse-margin collapse-icon mt-2" id="faq-payment-qna">
                            <div class="card">
                                <div class="card-header" id="paymentOne" data-toggle="collapse" role="button"
                                    data-target="#faq-payment-one" aria-expanded="false"
                            ...
                            <div class="card">
                                <div class="card-header" id="paymentTwo" data-toggle="collapse" role="button"
                                    ...
                                    <span class="lead collapse-title">Can I store the item on an intranet so everyone
                                        has access?</span>
                                </div>
                            ...
                            <div class="card">
                                <div class="card-header" id="paymentThree" data-toggle="collapse" role="button"
                                    data-target="#faq-payment-three" aria-expanded="false"
                            ...
                            <div class="card">
                                <div class="card-header" id="paymentFour" data-toggle="collapse" role="button"
                                    data-target="#faq-payment-four" aria-expanded="false"
                                    aria-controls="faq-payment-four">
                                    <span class="lead collapse-title">Is the Regular License the same thing as an
                                        editorial license?</span>
                                </div>
                            ...
                            <div class="card">
                                <div class="card-header" id="paymentFive" data-toggle="collapse" role="button"
                                    data-target="#faq-payment-five" aria-expanded="false"
                            ...
                            <div class="card">
                                <div class="card-header" id="paymentSix" data-toggle="collapse" role="button"
                                    data-target="#faq-payment-six" aria-expanded="false"
                                    aria-controls="faq-payment-six">
                                    <span class="lead collapse-title">Which license do I need to use an item in a
                                        commercial?</span>
                                </div>
                                <div id="faq-payment-six" class="collapse" aria-labelledby="paymentSix"
                                    ...
                                    <div class="card-body">
                                        ...
                                        euismod. Dui vivamus
                                        arcu felis bibendum. Turpis in eu mi bibendum neque egestas congue. Nullam ac
                                        tortor vitae purus
                            ...
                            <div class="card">
                                <div class="card-header" id="paymentSeven" data-toggle="collapse" role="button"
                                    data-target="#faq-payment-seven" aria-expanded="false"
                        ...
                        <div class="collapse-margin collapse-icon mt-2" id="faq-delivery-qna">
                            <div class="card">
                                <div class="card-header" id="deliveryOne" data-toggle="collapse" role="button"
                                    data-target="#faq-delivery-one" aria-expanded="false"
                            ...
                            <div class="card">
                                <div class="card-header" id="deliveryTwo" data-toggle="collapse" role="button"
                                    data-target="#faq-delivery-two" aria-expanded="false"
                                    aria-controls="faq-delivery-two">
                                    <span class="lead collapse-title">
                                        The shipment status shows that it has been returned/cancelled. What does it mean
                                        and who do I contact?
                                    </span>
                                </div>
                                <div id="faq-delivery-two" class="collapse" aria-labelledby="deliveryTwo"
                                    data-parent="#faq-delivery-qna">
                                    <div class="card-body">
                                        Sweet pie candy jelly. Sesame snaps biscuit sugar plum. Sweet roll topping
                                        fruitcake. Caramels
                            ...
                            <div class="card">
                                <div class="card-header" id="deliveryThree" data-toggle="collapse" role="button"
                                    data-target="#faq-delivery-three" aria-expanded="false"
                            ...
                            <div class="card">
                                <div class="card-header" id="deliveryFour" data-toggle="collapse" role="button"
                                    data-target="#faq-delivery-four" aria-expanded="false"
                            ...
                            <div class="card">
                                <div class="card-header" id="deliveryFive" data-toggle="collapse" role="button"
                                    data-target="#faq-delivery-five" aria-expanded="false"
                        ...
                        <div class="collapse-margin collapse-icon mt-2" id="faq-cancellation-qna">
                            <div class="card">
                                <div class="card-header" id="cancellationOne" data-toggle="collapse" role="button"
                                    data-target="#faq-cancellation-one" aria-expanded="false"
                            ...
                            <div class="card">
                                <div class="card-header" id="cancellationTwo" data-toggle="collapse" role="button"
                                    data-target="#faq-cancellation-two" aria-expanded="false"
                                    aria-controls="faq-cancellation-two">
                                    <span class="lead collapse-title">How can I get the contact number of my delivery
                                        agent?</span>
                                </div>
                            ...
                            <div class="card">
                                <div class="card-header" id="cancellationFour" data-toggle="collapse" role="button"
                                    data-target="#faq-cancellation-four" aria-expanded="false"
                                    aria-controls="faq-cancellation-four">
                                    <span class="lead collapse-title">I have received a defective/damaged product. What
                                        do I do?</span>
                                </div>
                            ...
                            <div class="card">
                                <div class="card-header" id="cancellationFive" data-toggle="collapse" role="button"
                                    data-target="#faq-cancellation-five" aria-expanded="false"
                            ...
                            <div class="card">
                                <div class="card-header" id="cancellationSix" data-toggle="collapse" role="button"
                                    data-target="#faq-cancellation-six" aria-expanded="false"
                                ...
                                <div id="faq-cancellation-six" class="collapse" aria-labelledby="cancellationSix"
                                    ...
                                    <div class="card-body">
                                        ...
                                        tortor consequat id.
                                        Fringilla est ullamcorper eget nulla facilisi. Morbi tristique senectus et netus
                                        et.
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="collapse-margin collapse-icon mt-2" id="faq-my-order-qna">
                            <div class="card">
                                <div class="card-header" id="myOrderOne" data-toggle="collapse" role="button"
                                    data-target="#faq-my-order-one" aria-expanded="false"
                            ...
                            <div class="card">
                                <div class="card-header" id="myOrderTwo" data-toggle="collapse" role="button"
                                    data-target="#faq-my-order-two" aria-expanded="false"
                            ...
                            <div class="card">
                                <div class="card-header" id="myOrderThree" data-toggle="collapse" role="button"
                                    data-target="#faq-my-order-three" aria-expanded="false"
                                    aria-controls="faq-my-order-three">
                                    <span class="lead collapse-title"> How can I ship my order to an international
                                        location? </span>
                                </div>
                            ...
                            <div class="card">
                                <div class="card-header" id="myOrderFour" data-toggle="collapse" role="button"
                                    data-target="#faq-my-order-four" aria-expanded="false"
                                    aria-controls="faq-my-order-four">
                                    <span class="lead collapse-title"> I missed the delivery of my order today. What
                                        should I do? </span>
                                </div>
                            ...
                            <div class="card">
                                <div class="card-header" id="myOrderFive" data-toggle="collapse" role="button"
                                    data-target="#faq-my-order-five" aria-expanded="false"
                                    aria-controls="faq-my-order-five">
                                    <span class="lead collapse-title"> The delivery of my order is delayed. What should
                                        I do? </span>
                                </div>
                        ...
                        <div class="collapse-margin collapse-icon mt-2" id="faq-product-qna">
                            <div class="card">
                                <div class="card-header" id="productOne" data-toggle="collapse" role="button"
                                    data-target="#faq-product-one" aria-expanded="false"
                                    aria-controls="faq-product-one">
                                    <span class="lead collapse-title">
                                        How can I register a complaint against the courier executive who came to deliver
                                        my order?
                                    </span>
                                </div>
                            ...
                            <div class="card">
                                <div class="card-header" id="productTwo" data-toggle="collapse" role="button"
                                    data-target="#faq-product-two" aria-expanded="false"
                            ...
                            <div class="card">
                                <div class="card-header" id="productThree" data-toggle="collapse" role="button"
                                    data-target="#faq-product-three" aria-expanded="false"
                                    aria-controls="faq-product-three">
                                    <span class="lead collapse-title">How can I get a proof of delivery for my
                                        shipment?</span>
                                </div>
                            ...
                            <div class="card">
                                <div class="card-header" id="productFour" data-toggle="collapse" role="button"
                                    data-target="#faq-product-four" aria-expanded="false"
