    ...
    <div class="col-lg-12 col-sm-12">
        <div class="card">
            <div class="card-header">
                <h3>Package Subscription <sub><small>(View Subscription)</small></sub></h3>
            </div>
            <div class="card-body">
                {{-- table Start --}}
                <div class="row">
                            ...
                            <table class="table table-sm table-hover-animation">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>20-11-2021 12:05 PM</td>
                                        <td>20-11-2024 12:05 PM</td>
                                        <td>BDT 100,00,00</td>
                                        <td>Offline</td>
                                        <td></td>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12 col-sm-12">
                                            <div class="form-group d-flex justify-content-between align-items-center">
                                                <label style=" 20%" for="basicInput">Upload Logo:</label>
