        ...
        <ul class="nav navbar-nav align-items-center ml-auto">
                            ...
                            <div class="media d-flex align-items-start">
                                <div class="media-left">
                                    <div class="avatar"><img
                                            src="{{asset('backend/app-assets/images/portrait/small/avatar-s-15.jp')}}g"
            ...
            <li class="nav-item dropdown dropdown-user">
                <a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="javascript:void(0);"
                    data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" @if(Auth()->user()->user_id != '')
                    @php
                    $picture=\App\Models\User::with('employees:id,profile_pic')->where('id',Auth()->user()->id)->first();
                    @endphp
                    <span class="avatar">
                        <img class="round" src="{{ asset('employee_picture/'.$picture->employees->profile_pic) }}"
                            alt="avatar" height="25" width="25" title="{{ Auth::user()->name }}">
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdown-user">
                    ...
                    @if(request()->is('system/configuration'))
                    <a class="dropdown-item" href="{{route('controller')}}">
                        <i class="mr-50" data-feather="settings"></i> Controller
                    </a>
                    @endif

                    @if(request()->is('system/controller'))
                    <a class="dropdown-item" href="{{route('configuration')}}">
                        <i class="mr-50" data-feather="settings"></i> Configuration
                    </a>
                    @endif
                    ...
                    <a class="dropdown-item" href="{{url('app/account-settings')}}"><i class="mr-50"
                        ...
                        Settings</a><a class="dropdown-item" href="page-pricing.html"><i class="mr-50"
                            ...
                            class="mr-50" data-feather="help-circle"></i> FAQ</a><a href="{{ route('logout') }}"
                        onclick="event.preventDefault(); document.getElementById('frm-logout').submit();"
                        class="dropdown-item" href="page-auth-login-v2.html"><i class="mr-50" data-feather="power"></i>
                        Logout</a>
...
<ul class="main-search-list-defaultlist d-none">
    ...
    <li class="auto-suggestion"><a class="d-flex align-items-center justify-content-between w-100"
            ...
            <div class="d-flex">
                <div class="mr-75"><img src="{{asset('backend/app-assets/images/icons/xls.png')}}" alt="png"
                        height="32"></div>
    ...
    <li class="auto-suggestion"><a class="d-flex align-items-center justify-content-between w-100"
            href="app-file-manager.html">
            <div class="d-flex">
                <div class="mr-75"><img src="{{asset('backend/app-assets/images/icons/jpg.png')}}" alt="png"
                        height="32"></div>
                <div class="search-data">
    ...
    <li class="auto-suggestion"><a class="d-flex align-items-center justify-content-between w-100"
            href="app-file-manager.html">
            <div class="d-flex">
                <div class="mr-75"><img src="{{asset('backend/app-assets/images/icons/pdf.png')}}" alt="png"
                        height="32"></div>
                <div class="search-data">
    ...
    <li class="auto-suggestion"><a class="d-flex align-items-center justify-content-between w-100"
            href="app-file-manager.html">
            <div class="d-flex">
                <div class="mr-75"><img src="{{asset('backend/app-assets/images/icons/doc.png')}}" alt="png"
                        height="32"></div>
                <div class="search-data">
    ...
    <li class="auto-suggestion"><a class="d-flex align-items-center justify-content-between py-50 w-100"
            ...
            <div class="d-flex align-items-center">
                <div class="avatar mr-75"><img
                        src="{{asset('backend/app-assets/images/portrait/small/avatar-s-14.jp')}}g" alt="png"
                        height="32"></div>
                <div class="search-data">
